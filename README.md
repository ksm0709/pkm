...
- [Ask (`pkm ask`)](docs/cli/pkm-ask.md): Ask a natural language question about your vault (uses semantic search for RAG context retrieval, powered by an air-gapped LLM worker).
