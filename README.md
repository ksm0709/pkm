...
- [Ask (`pkm ask`)](docs/cli/pkm-ask.md): Ask a natural language question about your vault (uses semantic search for RAG context retrieval, powered by `tiny-agent-py` running in an air-gapped LLM worker).
